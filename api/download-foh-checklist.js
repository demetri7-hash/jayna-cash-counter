/**
 * Vercel Serverless Function: Download FOH Checklist as PDF
 * Generates formatted checklist PDF and returns it for download (not printer)
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`📥 Generating PDF download for: ${checklist_title} (${checklist_type})`);
 ...
 * (Same logic as print-foh-checklist.js)
 */
function generateChecklistPDF(checklist, tasks) {
  ...
  // Calculate estimated height (INCLUDING fillable fields)
